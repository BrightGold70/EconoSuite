...
packages = [
    ...
    "lmtest", "sandwich", "AER", "plm", "fixest",
    "forecast", "tseries", "urca", "vars",
    "MatchIt", "rdrobust", "Synth",
    "psych", "Hmisc", "car", "gtsummary", "corrplot", "report",
    "stargazer", "modelsummary", "kableExtra", "rmarkdown", "knitr"
]
