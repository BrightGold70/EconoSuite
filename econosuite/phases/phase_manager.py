...
class ManuscriptMetadata:
    ...
    # NotebookLM session persistence — optional for backward compatibility
    notebooklm_session_id: str = ""
    ...
    def _save_state(self):
        ...
        data = {
            ...
            "metadata": {
                ...
                "notebooklm_session_id": self.metadata.notebooklm_session_id,
            },
...
""",
    ...
    def save(self):
        """Persist current phase manager state to disk."""
        self.metadata.last_modified = datetime.now()
        self._save_state()
